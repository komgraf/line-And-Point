...
lineDraw.prototype = new Grid();
lineDraw.prototype.constructor = lineDraw;
//lineDraw.prototype.convertX = function(value) {
//    value *= this.convert;
//
...
//
//// realY = (value * convert) 
//lineDraw.prototype.convertY = function(value) {
//    value *= this.convert;
//
...
//
//// x = (realX - x0) / convert
//lineDraw.prototype.reconvertX = function(value) {
//    value -= this.x0;
//    return (-1) * (value / this.convert);
//};
//
//lineDraw.prototype.reconvertY = function(value) {
//    value -= this.y0;
//    return (-1) * (value / this.convert);
//};
//
//lineDraw.prototype.getCoordinateText = function(x, y) {
//    return "(" + x + ", " + y + ")";
//};
//
//lineDraw.prototype.getCoordinateTextFromReal = function(realX, realY) {
//    xNew = this.convertX(x);
//    yNew = this.convertY(y);
//    return this.getCoordinateText(xNew, yNew);
//};

lineDraw.prototype.drawPoint = function(point) {
...
lineDraw.prototype.drawPoint2 = function(x, y, color, name) {
    xNew = this.convertX(x);
    yNew = this.convertY(y);
...
lineDraw.prototype.drawPointReal = function(realX, realY, color, text) {
...
//lineDraw.prototype.drawText = function(text, point) {
//    if (point.isReal === true) {
...
//};
//
//lineDraw.prototype.drawText2 = function(text, x, y) {
//    xNew = this.convertX(x);
//    yNew = this.convertY(y);
//    this.drawTextReal(text, xNew, yNew);
//};
//
//lineDraw.prototype.drawTextReal = function(text, realX, realY) {
//    this.ctx.fillText(text, realX + 1, realY - 1); // draw text
//};

lineDraw.prototype.drawLine = function(line) {
    if (line.isReal === true) {
...
//lineDraw.prototype.drawLine2 = function(pointA, pointB, color, arrowHead) {
//    this.drawLine3(pointA.x, pointA.y, pointB.x, pointB.y, color, arrowHead);
//};
//
//lineDraw.prototype.drawLine3 = function(x1, y1, x2, y2, color, arrowHead) {
//
//    x1 = this.convertX(x1);
//    y1 = this.convertY(y1);
//    x2 = this.convertX(x2);
...
//lineDraw.prototype.drawLineReal = function(realX1, realY1, realX2, realY2, color, arrowHead) {
...
// this block of code is a credit to http://stackoverflow.com/questions/16025326/html-5-canvas-complete-arrowhead
//lineDraw.prototype.drawArrowHead = function(x, y, radians) {
//    this.ctx.save();
//    this.ctx.beginPath();
...
//lineDraw.prototype.drawXY = function() {
...
//lineDraw.prototype.drawGrid = function() {
...
lineDraw.prototype.lineSubstraction = function(line) {
    this.lineSubstraction2(line.pointA, line.pointB);
};

lineDraw.prototype.lineSubstraction2 = function(pointA, pointB) {
...
lineDraw.prototype.lineSubstraction3 = function(x1, y1, x2, y2) {
...
lineDraw.prototype.vectorAddition = function(lineA, lineB) {
    // body...
};

lineDraw.prototype.reflectionXAxis = function(line) {
    this.reflectionY(line, 0);
};

lineDraw.prototype.reflectionYAxis = function(line) {
    this.reflectionX(line, 0);
};

lineDraw.prototype.reflectionCenter = function(line) {
    this.reflectionXY(line, 0, 0);
};

//refleksi terhadap garis sejajar sumbu Y. mencari X baru
lineDraw.prototype.reflectionX = function(line, n) {
...
lineDraw.prototype.reflectionY = function(line, n) {
...
lineDraw.prototype.reflectionXY = function(line, x, y) {
